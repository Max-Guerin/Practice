  ...
  return (
    <div className="App">
     ...
     <table cellspacing="10">
                <tr>
                    <td><img className="main-img" src="./images/coast.jpg" alt="Coast" height="500px" width="1000px" /></td>
                    <td><h1>Max Guerin</h1>
                    <p><em>Junior Web Developer.</em></p>
                    <p>Learning how to create a website using HTML to start with. Learn CSS and Javascript further down the track.</p></td>
                </tr>
            </table>
